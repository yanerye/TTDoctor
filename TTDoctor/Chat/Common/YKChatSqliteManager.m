...
@implementation YKChatSqliteManager
{
...
+ (instancetype)defaultManager{
    ...
    static YKChatSqliteManager *manager;
    dispatch_once(&onceToken, ^{
        manager = [[YKChatSqliteManager alloc] init];
    });
    return manager;
}
...
- (NSArray *)allPropertyNameInClass:(Class)cls{
    if ([cls isSubclassOfClass:[YKChatBaseModel class]]) {
...
- (NSDictionary *)DictionaryFromModel:(id)model{
    if ([model isKindOfClass:[YKChatBaseModel class]]) {
