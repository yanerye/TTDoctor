...
@interface YKSelectMainSymptomVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation YKSelectMainSymptomVC
{
    YKDoctor *_doctor;
    NSString *_deptName;
...
- (void)doneClick{
    ...
    if (self.block) {
        self.block(goodsIDString, goodsNameString);
    }
