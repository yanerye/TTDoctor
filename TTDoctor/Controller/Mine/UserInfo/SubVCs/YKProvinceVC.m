...
@interface YKProvinceVC ()<UITableViewDelegate,UITableViewDataSource>
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSDictionary *cityDic = [NSDictionary dictionaryWithDictionary:_dataArray[indexPath.row]];
    if (_cityBlock) {
        _cityBlock(cityDic);
    }
