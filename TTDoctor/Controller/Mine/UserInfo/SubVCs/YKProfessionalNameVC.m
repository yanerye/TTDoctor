...
@interface YKProfessionalNameVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation YKProfessionalNameVC
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSDictionary *professionalDic = [NSDictionary dictionaryWithDictionary:_dataArray[indexPath.row]];
    if (_professionalBlock) {
        _professionalBlock(professionalDic);
    }
