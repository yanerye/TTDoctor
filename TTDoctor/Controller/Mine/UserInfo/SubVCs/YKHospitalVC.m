...
@interface YKHospitalVC ()<UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource>
...
- (UITextField *)searchTextField{
    if (!_searchTextField) {
        ...
        _searchTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"请输入医院名字" attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:13],NSForegroundColorAttributeName:RGBACOLOR(153, 153, 153)}];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"%@",dict[@"hospitalName"]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSDictionary *hospitalDic = [NSDictionary dictionaryWithDictionary:_dataArray[indexPath.row]];
    if (_hospitalBlock) {
        _hospitalBlock(hospitalDic);
    }
